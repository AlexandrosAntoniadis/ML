...
if PCA_used=='yes':
    ...
    #for example
    #var1 = [73.43, 86.75, 88.21, 89.29, 90.25, 99.99]
    ...
    #var1<percentage_to_keep_PCA give True to the ones that I want to keep
    #then sum them
    ...
    #I concat the variables from PCA with the labels that were drop at the beginning
...
newdf = reg.predict(newdf[:]) #applying the saved model to new star
